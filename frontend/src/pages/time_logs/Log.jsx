...
const Log = ({ log }) => {
    ...
    return (
        <tr>
            ...
            <td>{log.hours}</td>
            <td>{log.injury_noted ? <i className="fa fa-check"></i> : <i className="fa fa-times"></i>}</td>
            <td>{log.policy_violation_noted ? <i className="fa fa-check"></i> : <i className="fa fa-times"></i>}</td>
